    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div>
                    <a class="btn btn-default" target="_BLANK" href="/subscribers/generate">Generate Subscriber List</a>
                    <br>
                </div>
                        ...
                        <table id="team-table" class="table table-striped">
                            ...
                            @forelse ($subscribers as $subscriber )
                                <tr>
                                    ...
                                    <td class="{{$subscriber->subscribed==true?'text-success':'text-danger'}} font-weight-bold">
                                    {{$subscriber->subscribed==true?'Subscribed':'Unsubscribed'}}</td>
                                    
                                    <td>{{date_format( date_create($subscriber->created_at),'D, d M Y  ')}}</td>
                                    <td>
                                        ...
                                        <div class="btn-group">
                                          ...
                                          <div class="dropdown-menu" role="menu" >
                                            ...
                                            <form action="/subscribers/{{$subscriber->id}}" method="post" onsubmit="return confirm('Are you sure you want to delete this subscriber?');">
                                            @csrf 
                                            @method('DELETE')
